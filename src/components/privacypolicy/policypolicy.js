...
const Privacypolicy = () => {
  return (
    <div
      style={{
        fontFamily: "globalFont,Helvetica Neue, Helvetica, Arial, sans-serif",
        padding: "1em",
        // maxWidth: "800px",
        // margin: "0 auto",
        lineHeight: "1.6",
    ...
    >
      ...
      <div style={{ marginTop: "1rem" }}>
        <p>
          This privacy policy applies to the Clippet app (hereby referred to as
          {" Application"}) for mobile devices that was created by Clippet
          Technologies Private Limited (hereby referred to as{" "}
          {"Service Provider"}) as a Commercial service. This service is
        ...
        <p>
          ...
          identifiable information, including but not limited to Email, Mobile
          Number, Name, Organisation Name. The information that the Service
          Provider requests will be retained by them and used as described in
          this privacy policy.
        </p>
        <br />
        ...
        <p>
          ...
          Application, please contact them at support@clippet.in and they will
        ...
        <div>
          ...
          <p>
            ...
            please contact the Service Provider{" (support@clippet.ai)"} so that
        ...
        <br />
        <p>This privacy policy is effective as of 2024-07-15</p>
        <br />
        ...
        <p>
          ...
          Service Provider via email at support@clippet.ai
        </p>
      </div>
    </div>
  );
