                ...
                <Box sx={{ flex: "0 0 15%" }}>
                    <div>
                        ...
                        <div className={style.socialIcons}>
                            <a href="https://www.instagram.com/clippet.design/" target="_blank" rel="noreferrer"><InstagramIcon className={style.icons}/></a>
                            <a href='https://www.facebook.com/clippet.design/' target='_blank' rel="noreferrer"><FacebookIcon  className={style.icons}/></a>
                            <a href="https://www.linkedin.com/company/clippet/" target="_blank" rel="noreferrer"><LinkdeIn className={style.icons} /></a>
                            <a href="https://www.youtube.com/@clippet.design" target='_blank' rel="noreferrer"><YouTubeIcon className={style.icons}/></a>
                        </div>
                    </div>
                </Box>
            </Grid2>
