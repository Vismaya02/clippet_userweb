...
const Termsandconditions = () => {
  return (
    ...
    >
      ...
      <br />
      <p>
        These terms and conditions apply to the Clippet app (hereby referred to
        as {" Application"}) for mobile devices that was created by Clippet
        Technologies Private Limited (hereby referred to as {"Service Provider"}
      ...
      <br />
      <p>These terms and conditions are effective as of 2024-07-15</p>
      <br />
